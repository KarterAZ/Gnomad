...
public class SuperchargerData
{
    ...
    public Dictionary<string, AddressData> address { get; set; } //Useful. Address and only use data if !strcmp(address["country"], "USA")
    public Dictionary<string, LatitudeAndLongitude> gps { get; set; } //Useful.
